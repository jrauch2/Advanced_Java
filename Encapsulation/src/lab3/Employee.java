...
public class Employee {
    ...
    */
    ...
    private void meetWithHrForBenefitAndSalryInfo() {
        metWithHr = true;
        output.doOutput(firstName + " " + lastName + " met with Hr on "
            + getFormattedDate());
    }
    ...
    private void meetDepartmentStaff() {
        metDeptStaff = true;
        output.doOutput(firstName + " " + lastName + " met with Dept. Staff on "
            + getFormattedDate());
    }
    ...
    public void reviewDeptPolicies() {
        ...
        output.doOutput(firstName + " " + lastName + " reviewed Dept policies on "
            + getFormattedDate());
    }
    ...
    public void moveIntoCubicle(String cubeId) {
        setCubeId(cubeId);
        this.movedIn = true;
        output.doOutput(firstName + " " + lastName + " moved into cubicle "
